...
class LcarsRectangle(LcarsBase):
    ...
    def _create_frames(self) -> None:
        ...
        self.frame = tk.Frame(self.window, bg=background_color, height=50, width=800)
    ...
    def _add_widgets(self) -> None:
        ...
        self.label_headline = tk.Label(self.frame, font=main_font, bg=background_color, fg=headline_color, text='LCARS RECTANGLE')
